...
void test_buildArgs() {
    ...
    test("buildArgs createstruct", arg != NULL && arg->left == 0 && arg->right == 99 && arg->level == 0);
    free(arg);
}
...
void test_two() {
    ...
    parallel_mergesort(arg);
    test("Two elements sorted", A[0] == 5 && A[1] == 10);
    free(arg);
    free(A);
    free(B);
}
...
void test_small_serial() {
    ...
    parallel_mergesort(arg);
    test("100 elements sorted (serial)", is_sorted(size));
    free(arg);
    free(A);
    free(B);
}
...
void test_small_parallel() {
    ...
    struct argument *arg = buildArgs(0, size - 1, 0);
    parallel_mergesort(arg);
    test("100 elements sorted (parallel)", is_sorted(size));
    free(arg);
    free(A);
    free(B);
}
...
void test_sorted() {
    ...
    struct argument *arg = buildArgs(0, size - 1, 0);
    parallel_mergesort(arg);
    test("Already sorted stays sorted", is_sorted(size));
    free(arg);
    free(A);
    free(B);
}
...
void test_reverse() {
    ...
    struct argument *arg = buildArgs(0, size - 1, 0);
    parallel_mergesort(arg);
    test("Reverse sorted gets sorted", is_sorted(size));
    free(arg);
    free(A);
    free(B);
}
...
void test_duplicates() {
    ...
    struct argument *arg = buildArgs(0, size - 1, 0);
    parallel_mergesort(arg);
    test("All duplicates sorted", is_sorted(size));
    free(arg);
    free(A);
    free(B);
}
